            ...
            <section className="container mx-auto px-6 lg:px-8 py-16 flex items-center justify-center min-h-[calc(100vh-100px)]">
                <div className="w-full max-w-md">
                    ...
                    <div className="bg-white rounded-3xl p-8 md:p-10 shadow-2xl border border-white/50">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-gray-600">
                                Sign in to your StudySwap account
                            </p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="flex items-center justify-between text-sm">
                                <label className="flex items-center gap-2 cursor-pointer">
                                    <input type="checkbox" className="w-4 h-4 rounded border-gray-300 accent-[#57C785]" />
                                    <span className="text-gray-600">Remember me</span>
                                </label>
                                <a href="#" className="text-[#2A7B9B] hover:text-[#1f607b] transition-colors font-semibold">
                                    Forgot password?
                                </a>
                            </div>
                            ...
                            <button
                                type="submit"
                                className="w-full px-6 py-3 bg-[#2A7B9B] text-white rounded-full font-semibold text-lg shadow-lg shadow-blue-200 hover:bg-[#1f607b] hover:scale-105 transition-all duration-300 mt-6"
                            >
                                Sign In
                            </button>
                        </form>
                        ...
                        <div className="text-center mt-6">
                            <p className="text-gray-600">
                                ...
                                <a href="#" className="text-[#57C785] font-semibold hover:text-[#45b372] transition-colors">
                                    Sign Up
                                </a>
                            </p>
                        </div>
                    ...
                    <div className="mt-8 grid grid-cols-3 gap-4 text-center">
                        ...
                        <div>
                            <div className="text-2xl font-bold text-[#57C785]">✨</div>
                            <p className="text-xs text-gray-600 mt-1">Simple</p>
                        </div>
                    </div>
                </div>
            </section>
